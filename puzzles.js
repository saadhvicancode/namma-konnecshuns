...
const PUZZLES = [
  ...
  { id: 3, groups: [
    { level: 0, domain: "PLACE", name: "WHAT THE CITY IS CALLED", words: ["BENDAKALURU", "GARDEN CITY", "SILICON VALLEY", "PUB CITY"] },
  ...
  { id: 8, groups: [
    { level: 0, domain: "CITY", name: "BASAVANAGUDI LANDMARKS", words: ["NATIONAL COLLEGE", "VIDYARTHI BHAVAN", "BULL TEMPLE", "RAMAKRISHNA ASHRAM"] },
    { level: 1, domain: "LANG", name: "SLANG FOR 'FRIEND'", words: ["MACHA", "MAGA", "ANNA", "BRO"] },
    { level: 2, domain: "TRANSPORT", name: "TERMINAL STATIONS", words: ["CHALLAGHATTA", "WHITEFIELD", "SILK INSTITUTE", "MADAVARA"] },
  ...
  { id: 12, groups: [
    { level: 0, domain: "CITY", name: "MALLESWARAM LANDMARKS", words: ["8TH CROSS", "KADU MALLESHWARA", "SANKEY TANK", "MANTRI SQUARE"] },
    ...
    { level: 3, domain: "WORDPLAY", name: "___ SANDRA", words: ["JAKKA", "BYRA", "THIPPA", "CHIKKA"] }
  ]},
  { id: 13, groups: [
    ...
    { level: 2, domain: "CITY", name: "ROADS NAMED FOR PEOPLE", words: ["KAMARAJ", "NRUPATHUNGA", "KASTURBA", "SESHADRI"] },
  ...
  { id: 17, groups: [
    ...
    { level: 1, domain: "TRANSPORT", name: "METRO TERMINALS", words: ["CHALLAGHATTA", "WHITEFIELD", "SILK INSTITUTE", "MADAVARA"] },
    { level: 2, domain: "ARTS", name: "GIRISH KARNAD PLAYS", words: ["TUGHLAQ", "HAYAVADANA", "NAGAMANDALA", "YAYATI"] },
    { level: 3, domain: "WORDPLAY", name: "___ ROAD (IN TOWN)", words: ["100 FEET", "OLD AIRPORT", "DOUBLE", "TANNERY"] }
  ]},
  { id: 18, groups: [
  ...
  { id: 20, groups: [
    ...
    { level: 1, domain: "PLACE", name: "SATELLITE TOWNS", words: ["HOSKOTE", "NELAMANGALA", "ANEKAL", "ATTIBELE"] },
  ...
  { id: 21, groups: [
    { level: 0, domain: "WORDPLAY", name: "___ TOWN", words: ["FRAZER", "COOKE", "COX", "BENSON"] },
  ...
  { id: 22, groups: [
    ...
    { level: 2, domain: "FOOD", name: "OLD FOOD JOINTS NEARBY", words: ["VEENA STORES", "HALLI MANE", "NEW MODERN", "CTR"] },
    { level: 3, domain: "WORDPLAY", name: "___ ROAD (HIGHWAYS)", words: ["NICE", "OLD MADRAS", "TUMKUR", "KANAKAPURA"] }
  ]},
  { id: 23, groups: [
  ...
  { id: 25, groups: [
    ...
    { level: 3, domain: "WORDPLAY", name: "___ ROAD STATION", words: ["MYSORE", "MAGADI", "RV", "SAMPIGE"] }
  ]},
  { id: 26, groups: [
  ...
  { id: 30, groups: [
    ...
    { level: 1, domain: "WORDPLAY", name: "___ NAGAR", words: ["CV RAMAN", "RAJAJI", "JAYA", "INDIRA"] },
  ...
  { id: 31, groups: [
    ...
    { level: 2, domain: "WORDPLAY", name: "___ TECH PARK", words: ["PRESTIGE", "BAGMANE", "GLOBAL VILLAGE", "MANYATA"] },
  ...
  { id: 32, groups: [
    ...
    { level: 3, domain: "WORDPLAY", name: "___ PURA", words: ["DODDABALLA", "VIJAYA", "KEMPA", "SRIRAMA"] }
  ]},
  { id: 33, groups: [
  ...
  { id: 35, groups: [
    ...
    { level: 1, domain: "NATURE", name: "REVIVED LAKES", words: ["PUTTENAHALLI", "KAIKONDRAHALLI", "JAKKUR", "RACHENAHALLI"] },
  ...
  { id: 36, groups: [
    ...
    { level: 3, domain: "WORDPLAY", name: "___ RING ROAD", words: ["OUTER", "INNER", "PERIPHERAL", "NICE"] }
  ]},
  { id: 37, groups: [
  ...
  { id: 41, groups: [
    ...
    { level: 2, domain: "PLACE", name: "BEFORE THE RENAMING", words: ["GULBARGA", "BELLARY", "BIJAPUR", "HUBLI"] },
